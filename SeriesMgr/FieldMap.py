...
standard_field_aliases = (
	...
	('machine',
		('Machine','Machine Name','MachineName','Rider Machine','Cycle','Cycle Name','CycleName','Rider Cycle','Bike','Bike Name','BikeName','Rider Bike','Vehicle','Vehicle Name','VehicleName','Rider Vehicle','HPV','Car','Velo','Velomobile','Wheelchair','Fiets','Rad'),
		"Machine",
	),
	('discipline',
		('Discipline',),
